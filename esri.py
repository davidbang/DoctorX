...
"""https://github.com/Esri/developer-support/blob/master/python/general-python/create-drive-times/create-drive-times.py"""
...
class ArcGISOnline(object):
    ...
    def generateToken(username, password):
        return {'ssl': kP8luwsA_mI8VMUXekQm55hXPmItvB6FTBun3AdPlc6bem7_evvU4kfwBYif1gH96FJHv-0Y5h91z1I-B1FI56HwXVClaMilLJEbiIl-PLnPu27BiOWNhFLPP8zTEAMDFeRmKXytuXxg9UmTcazlOQ..}
    ...
    def CreateDriveTimes(self, featureLayerURL, WHERE_CLAUSE, breakValues, breakUnits, overlapPolicy, OUTPUTNAME):
        ...
        data[''] = self.GetTravelModes("Driving Time")
        ...
        task_url, job_info = self.analysis_job(self.__analysis_url, "PlanRoutes", data)
